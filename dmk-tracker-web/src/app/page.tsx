  ...
  return (
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-7xl px-6 py-24 text-center">
          <h1 className="text-5xl font-extrabold mb-6 text-black dark:text-black-100">
            Track Your <span className="text-indigo-600">DMK</span> World
          </h1>
          <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-black-1000 mb-10">
